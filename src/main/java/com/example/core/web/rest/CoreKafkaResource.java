...
@RestController
@RequestMapping("/api/core-kafka")
public class CoreKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CoreKafkaResource.class);
    ...
    public CoreKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
